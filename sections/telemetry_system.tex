...
in smaller rockets for test flights. This would allow testing of the avionics software in-flight before competition flights, which
normally highlight many integration issues.
